...
"}")
        ...
        sizePolicy1.setHeightForWidth(self.lw_serials.sizePolicy().hasHeightForWidth())
        self.lw_serials.setSizePolicy(sizePolicy1)
...
"    }")
        ...
        self.gridLayout.addLayout(self.vl_center, 3, 1, 1, 1)
...
"}")
        ...
        sizePolicy4.setHeightForWidth(self.le_serials.sizePolicy().hasHeightForWidth())
        self.le_serials.setSizePolicy(sizePolicy4)
...
"    }")
        ...
        self.pb_import.setIcon(icon1)
        self.pb_import.setIconSize(QSize(24, 24))
...
"    }")
        ...
        self.gridLayout.addLayout(self.vl_bottom, 12, 1, 1, 1)
